...
await Deno.writeTextFile("./bitcoin_rate.csv", `${json.time.updatedISO};${json.bpi.USD.rate_float};${json.bpi.GBP.rate_float};${json.bpi.EUR.rate_float};${json.bpi.CNY.rate_float}`, {append: true});
